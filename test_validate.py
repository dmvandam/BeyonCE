...
def test_number_bounds_value_low_exclusive_false() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must be greater than or"
        f" equal to {lower_bound:.4f}")
...
def test_number_bounds_value_low_exclusive_true() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must be greater than"
        f" {lower_bound:.4f}")
...
def test_number_bounds_value_high_exclusive_false() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must be less than or "
        f"equal to {upper_bound:.4f}")
...
def test_number_bounds_value_high_exclusive_true() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must be less than"
        f" {upper_bound:.4f}")
...
def test_array_bounds_value_low_exclusive_false() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must contain solely "
        f"values greater than or equal to {lower_bound:.4f}")
...
def test_array_bounds_value_low_exclusive_true() -> None:
    ...
    assert str(ERROR.value) == (f"The {NAME} argument must contain solely "
        f"values greater than {lower_bound:.4f}")
